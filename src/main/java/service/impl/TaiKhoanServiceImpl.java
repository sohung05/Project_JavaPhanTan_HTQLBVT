...
public class TaiKhoanServiceImpl extends UnicastRemoteObject implements ITaiKhoanService {
    ...
    public List<Object[]> getAll() throws RemoteException {
        return em.createQuery("SELECT tk.nhanVien.maNhanVien, tk.tenTaiKhoan, tk.matKhau, tk.nhanVien.hoTen FROM TaiKhoan tk", Object[].class).getResultList();
    }
    ...
    public List<Object[]> timKiem(String maNV, String tenTaiKhoan, String tenNhanVien) throws RemoteException {
        StringBuilder jpql = new StringBuilder("SELECT tk.nhanVien.maNhanVien, tk.tenTaiKhoan, tk.matKhau, tk.nhanVien.hoTen FROM TaiKhoan tk WHERE 1=1");
