...
// Thêm vào panel
    ...
    private void loadData(int thang, int nam) {
        ...
        // Lấy dữ liệu từ DAO
        int tongLuongKhach = dao.getTongLuotKhach(thang, nam);
        int tongSoVe = dao.getTongSoVe(thang, nam);
        int tongSoTuyen = dao.getTongSoTuyen(thang, nam);
        ...
        java.util.List<Object[]> tuyenNhieuNhat = dao.getTuyenNhieuNhatTrongThang(thang, nam);
        ...
        pieDataset.clear();
        Map<entity.DoiTuong, Integer> tyLeDoiTuong = dao.getTiLeKhachHangTheoDoiTuong(thang, nam);
        for (Map.Entry<entity.DoiTuong, Integer> entry : tyLeDoiTuong.entrySet()) {
        ...
        // Load dữ liệu thực từ DAO
        Map<Integer, Integer> soVeTheoNgay = dao.getSoVeTheoNgay(thang, nam);
